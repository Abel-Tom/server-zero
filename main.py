...
def initialize():
    ...
    chat_llm = models.get_google_chat(model_name="gemini-1.5-pro", temperature=0)
...
async def server_chat(agent:Agent, msg, chain, prompt):
        # send message to agent0, 
        async for data in agent.chat_loop(msg, chain, prompt):
            yield data
...
def chat(agent:Agent):
    ...
    while True:
        ...
        print('ass resp ', assistant_response)
